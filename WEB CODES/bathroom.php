...
<body>
        ...
        <aside>
            ...
            <div class="sidebar">
                ...
                <a href="indexbath.php"  class="active">
                    <span class="material-icons-sharp">
                        bathtub
                    </span>
                    <h3>Bathroom</h3>
        ...
        <main>
            ...
            <div class="insights">
                ...
                <div class="Suhu">
                    ...
                    <small class="text-muted">Suhu pada kamar mandi</small>
                </div>
                <!-- --------------- KELEMBAPAN ---------------- -->
                <div class="Kelembapan">
                    ...
                    <small class="text-muted">Kelembapan pada kamar mandi</small>
                </div>
                <!-- --------------- LED ---------------- -->
                <div class="led">
                    <span class="material-icons-sharp">
                    ...
                    <small class="text-muted">LED pada kamar mandi</small>
                </div>
            </div>
            <!-- ================= TABLE ==================  -->
