...
<body>
        ...
        <aside>
            ...
            <div class="sidebar">
                ...
                <a href="indexkit.php" class="active">
                    <span class="material-icons-sharp">
                        countertops
                    </span>
                    <h3>Kitchen</h3>
        ...
        <main>
            ...
            <div class="insights">
                ...
                <div class="Suhu">
                    ...
                    <small class="text-muted">Suhu pada dapur</small>
                </div>
                <!-- --------------- KELEMBAPAN ---------------- -->
                <div class="Kelembapan">
                    ...
                    <small class="text-muted">Kelembapan pada dapur</small>
                </div>
                <!-- --------------- LED ---------------- -->
                <div class="led">
                    <span class="material-icons-sharp">
                    ...
                    <small class="text-muted">LED pada dapur</small>
                </div>
            </div>
            <!-- ================= TABLE ==================  -->
