...
<body>
        ...
        <aside>
            ...
            <div class="sidebar">
                ...
                <a href="indexliving.php" class="active">
                    <span class="material-icons-sharp">
                        chair
                    </span>
                    <h3>Living Room</h3>
        ...
        <main>
            ...
            <div class="insights">
                ...
                <div class="Suhu">
                    ...
                    <small class="text-muted">Suhu pada ruang tamu</small>
                </div>
                <!-- --------------- KELEMBAPAN ---------------- -->
                <div class="Kelembapan">
                    ...
                    <small class="text-muted">Kelembapan pada ruang tamu</small>
                </div>
                <!-- --------------- LED ---------------- -->
                <div class="led">
                    <span class="material-icons-sharp">
                    ...
                    <small class="text-muted">LED pada ruang tamu</small>
                </div>
            </div>
            <!-- ================= TABLE ==================  -->
