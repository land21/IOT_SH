...
void reconnect() {
  ...
  //     client.subscribe("iot/SH/bathroom/led");
  //   } else {
  ...
  //   }
  // }
  while (!client.connect("Bathroom","sh001","F9gh2Bdlj0OPOWoZ")) {
    Serial.print(".");
    delay(1000); 
  }
  Serial.println("Terhubung");
...
void loop() {
  ...
  Serial.print("Suhu : ");
  Serial.println(msg);
  client.publish("iot/SH/bathroom/Suhu", msg); 
  snprintf (msg, MSG_BUFFER_SIZE, "%s", itoa(h,msg,20));
  Serial.print("Kelembapan : ");
  Serial.println(msg);
  client.publish("iot/SH/bathroom/Kelembapan", msg); 
}